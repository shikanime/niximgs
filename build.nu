...
def format_nix_flake [build_context: string, image_name: string, platform_parts: record]: nothing -> string {
    $"($build_context)#($image_name)-($platform_parts.os)-($platform_parts.arch)"
}
